...
if __name__ == "__main__":
    ...
    bound_down          = rospy.get_param("~bound_down")
    train_rate          = rospy.get_param("~bound_down")
    wp_resolution       = rospy.get_param("~bound_down")
    path_nbr_samples    = rospy.get_param("~bound_down")
    voxel_size          = rospy.get_param("~bound_down")
    wp_sample_interval  = rospy.get_param("~bound_down")
    ...
    try:        
        ...
        # Run bayesian optimization based planner 
            ...
            planner = BOPlanner(corner_topic=corner_topic, path_topic=path_topic, bounds=bounds, 
                                turning_radius=turn_radius, training_rate=train_rate, wp_resolution=wp_resolution,
                                swath_width=swath_width, path_nbr_samples=path_nbr_samples, voxel_size=voxel_size,
                                wp_sample_interval=wp_sample_interval, horizon_distance=horizon_distance,
